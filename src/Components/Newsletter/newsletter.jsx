...
export const Newsletter = () => {
    return (
        <section className='newsletterCard w-[88%] h-[48vh] mt-3 mx-auto px-[5rem] flex items-center justify-between'>
            <div className="title"> <h1 className='w-[270px] text-4xl font-bold text-white'>Subscribe to our Newsletter</h1> </div>
