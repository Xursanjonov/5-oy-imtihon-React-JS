      ...
      <div className='w-full py-4 flex items-center justify-start gap-6'>
        ...
        <div className="w-full py-[5rem] flex flex-col items-start justify-around">
            <p className="pageName text-2xl font-semibold italic text-green-500">About Us</p>
              ...
              <button className='px-[2rem] py-[1rem] flex items-center justify-center gap-6 font-semibold rounded-xl text-white bg-blue-950'>
                  Explore More <i className="w-[1.37rem] h-[1.4rem] text-xl text-white bg-blue-800 flex items-center justify-center rounded-full"> <img src={noStars} /> </i>
              </button>
        </div>
    </div>
  )
